...
namespace Recorder
{
    public partial class MainWindow : Form
    {
        ...
        private void RefreshDevices()
        {
                ...
                CaptureMode == CaptureMode.Capture ? DataFlow.Capture : DataFlow.Render, DeviceState.Active))
            {
                foreach (MMDevice device in deviceCollection)
                {
                    ...
                    ListViewItem item = new ListViewItem(device.FriendlyName) { Tag = device };
        ...
        private void StartCapture(string fileName)
        {
            ...
            SingleBlockNotificationStream singleBlockNotificationStream = new SingleBlockNotificationStream(soundInSource.ToSampleSource());
