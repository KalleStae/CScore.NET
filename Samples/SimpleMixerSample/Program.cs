...
namespace SimpleMixerSample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SimpleMixer mixer = new SimpleMixer(2, mixerSampleRate) //output: stereo, 44,1kHz
            {
                FillWithZeros = true,
                DivideResult = true //you may play around with this
            };

            ChannelMatrix monoToLeftOnlyChannelMatrix = new ChannelMatrix(ChannelMask.SpeakerFrontCenter,
                ChannelMask.SpeakerFrontLeft | ChannelMask.SpeakerFrontRight);
            ChannelMatrix monoToRightOnlyChannelMatrix = new ChannelMatrix(ChannelMask.SpeakerFrontCenter,
                ChannelMask.SpeakerFrontLeft | ChannelMask.SpeakerFrontRight);
            ...
            */
            ...
            WasapiOut soundOut = new WasapiOut() { Latency = 200 }; //better use a quite high latency
