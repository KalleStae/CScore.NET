...
namespace WinformsVisualization
{
    public partial class Form1 : Form
    {
        ...
        private void SetupSampleSource(ISampleSource aSampleSource)
        {
            ...
            BasicSpectrumProvider spectrumProvider = new BasicSpectrumProvider(aSampleSource.WaveFormat.Channels,
            ...
            SingleBlockNotificationStream notificationSource = new SingleBlockNotificationStream(aSampleSource);
        ...
        private void GenerateLineSpectrum()
        {
            ...
            Bitmap newImage = _lineSpectrum.CreateSpectrumLine(pictureBoxTop.Size, Color.Green, Color.Red, Color.Black, true);
            if (newImage != null)
            {
