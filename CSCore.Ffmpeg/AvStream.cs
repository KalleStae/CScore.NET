...
namespace CSCore.Ffmpeg
{
    internal sealed class AvStream : IDisposable
    {
        ...
        public unsafe WaveFormat GetSuggestedWaveFormat()
        {
            ...
            WaveFormat waveFormat = new WaveFormat(_stream->codec->sample_rate, bitsPerSample, _stream->codec->channels,
                encoding);
            return waveFormat;
        }
        ...
        public unsafe AvStream(IntPtr stream)
        {
            ...
            AVCodecContext* avCodecContext = _stream->codec;
            AVCodec* decoder = FfmpegCalls.AvCodecFindDecoder(avCodecContext->codec_id);
