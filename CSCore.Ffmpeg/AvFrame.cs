...
namespace CSCore.Ffmpeg
{
    internal sealed class AvFrame : IDisposable
    {
        ...
        {
            AvStream stream = _formatContext.SelectedStream;
            AVCodecContext* decoderContext = stream.Stream.codec;
            bool decodingSuccess = FfmpegCalls.AvCodecDecodeAudio4(decoderContext, _frame, packet, out bytesConsumed);
