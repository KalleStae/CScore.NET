    ...
    public static class FfmpegUtils
    {
        ...
        private static unsafe void OnLogMessage(void* ptr, int level, byte* fmt, IntPtr vl)
        {
            lock (LockObj)
            {
                ...
                EventHandler<FfmpegLogReceivedEventArgs> eventHandler = FfmpegLogReceived;
        ...
        {
            EventHandler<ResolveFfmpegAssemblyLocationEventArgs> resolveEvent = ResolveFfmpegAssemblyLocation;
