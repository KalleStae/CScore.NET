    ...
    public class WasapiOut : ISoundOut
    {
        ...
        private void PlaybackProc(object playbackStartedEventWaithandle)
        {
            ...
            try
            {
                ...
                WaitHandle[] eventWaitHandleArray = _eventSync ? new WaitHandle[] { _streamSwitchEvent, _eventWaitHandle } : new WaitHandle[] { _streamSwitchEvent };
            ...
            finally
            {
                ...
                EventWaitHandle eventWaitHandle = playbackStartedEventWaithandle as EventWaitHandle;
      ...
      if (true)
                ...
                if (closestMatch == null || !audioClient.IsFormatSupported(_shareMode, closestMatch))
                {
                    ...
                    if (mixformat == null || !audioClient.IsFormatSupported(_shareMode, mixformat))
                    {
                        ...
                        if (_shareMode == AudioClientShareMode.Exclusive)
                        {
                            ...
                            WaveFormat deviceFormat = Device.DeviceFormat;
                            ...
                            if (!CheckForSupportedFormat(audioClient, possibleFormats, out mixformat))
                            {
                                ...
                                foreach (int sampleRate in new[] { 44100, 48000, 96000, 192000 })
                                {
        ...
        {
            AudioSessionDisconnectReason disconnectReason = e.DisconnectReason;
        ...
        {
            MMDevice defaultAudioEndpoint = MMDeviceEnumerator.DefaultAudioEndpoint(dataFlow, role);
