...
namespace CSCore.SoundOut
{
    ...
    public class WaveOut : ISoundOut
    {
        ...
        private void InitializeInternal()
        {
            ...
            Queue<WaveFormat> supportedFormats = new Queue<WaveFormat>(Device.SupportedFormats
            ...
            WaveFormat finalFormat = _source.WaveFormat;
            do
            {
                try
                {
            ...
            int bufferSize = (int)WaveSource.WaveFormat.MillisecondsToBytes(_latency);
