        ...
        private void PlaybackProc(object o)
        {
            ...
            try
            {
                ...
                /*
                     * Setup notify
                     */
                EventWaitHandle waitHandleNull = new EventWaitHandle(false, EventResetMode.AutoReset);
                EventWaitHandle waitHandle0 = new EventWaitHandle(false, EventResetMode.AutoReset);
                EventWaitHandle waitHandleEnd = new EventWaitHandle(false, EventResetMode.AutoReset);
            ...
            finally
            {
                ...
                if (waitHandles != null)
                {
                    ...
                    {
                        EventWaitHandle wh = (EventWaitHandle)waitHandle1;
                        wh.Close();
                    }
                }
