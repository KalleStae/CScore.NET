...
namespace CSCore.CoreAudioAPI
{
    ...
    public class MMDevice : ComObject
    {
        ...
        public DataFlow DataFlow
        {
            get
            {
                using (MMEndpoint endpoint = new MMEndpoint(this))
                {
        ...
        public WaveFormat DeviceFormat
        {
            get
            {
                Blob value = PropertyStore[PropertyStore.AudioEngineDeviceFormat].BlobValue;
                WaveFormat waveFormat = WaveFormatMarshaler.PointerToWaveFormat(value.Data);
                return waveFormat;
            }
        }
        ...
        public unsafe int ActivateNative(Guid iid, CLSCTX context, IntPtr activationParams, out IntPtr pinterface)
        {
            ...
            {
                int result = InteropCalls.CallI(UnsafeBasePtr, &iid, (uint)context, activationParams,
        ...
        public unsafe int GetIdNative(out string deviceid)
        {
            ...
            int err = InteropCalls.CallI(UnsafeBasePtr, &pdeviceid, ((void**)(*(void**)UnsafeBasePtr))[5]);
