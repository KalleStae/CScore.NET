...
namespace CSCore.SoundIn
{
    ...
    public class WasapiCapture : ISoundIn
    {
        ...
        {
            EventWaitHandle playbackStartedEventWaitHandle = param as EventWaitHandle;
        ...
        {
            WaveFormat defaultFormat = _waveFormat;
        ...
        private void RaiseDataAvailable(byte[] buffer, int offset, int count)
        {
            ...
            if (handler != null)
            {
                DataAvailableEventArgs e = new DataAvailableEventArgs(buffer, offset, count, WaveFormat);
        ...
        private void RaiseStopped(Exception exception)
        {
            ...
            if (handler != null)
            {
                RecordingStoppedEventArgs e = new RecordingStoppedEventArgs(exception);
                if (_synchronizationContext != null)
                {
                    _synchronizationContext.Post(o => handler(this, e), null); //use post instead of send to avoid deadlocks
                }
