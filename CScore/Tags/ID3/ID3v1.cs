...
namespace CSCore.Tags.ID3
{
    ...
    public class ID3v1
    {
        ...
        public void SaveToStream(Stream stream)
        {
            ...
            string title = Title.Length > 30 ? Title.Substring(0, 30) : Title;
            string artist = Artist.Length > 30 ? Title.Substring(0, 30) : Artist;
            string album = Album.Length > 30 ? Album.Substring(0, 30) : Album;
            int year = Year.HasValue ? Year.Value : 0;
            string comment = Comment.Length > 30 ? Comment.Substring(0, 30) : Comment;
            byte genre = (byte)Genre;
