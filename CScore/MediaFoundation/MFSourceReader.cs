...
namespace CSCore.MediaFoundation
{
    ...
    public class MFSourceReader : ComObject
    {
        ...
        {
            using (
                PropertyVariant value = GetPresentationAttribute(NativeMethods.MF_SOURCE_READER_MEDIASOURCE,
        ...
        public unsafe int GetNativeMediaTypeNative(int streamIndex, int mediatypeIndex, out MFMediaType mediaType)
        {
            ...
            int result = InteropCalls.CalliMethodPtr(UnsafeBasePtr, streamIndex, mediatypeIndex, &ptr, ((void**)(*(void**)UnsafeBasePtr))[5]);
        ...
        {
            IntPtr ptr = IntPtr.Zero;
            int result = InteropCalls.CalliMethodPtr(UnsafeBasePtr, streamIndex, &ptr, ((void**)(*(void**)UnsafeBasePtr))[6]);
            mediaType = new MFMediaType(ptr);
            return result;
        }
