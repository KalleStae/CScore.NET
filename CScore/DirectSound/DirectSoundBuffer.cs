...
namespace CSCore.DirectSound
{
    ...
    public unsafe class DirectSoundBuffer : ComObject
    {
        ...
        public DSResult GetCapsNative(out DSBufferCaps bufferCaps)
        {
            ...
            {
                DSResult result = InteropCalls.CalliMethodPtr(UnsafeBasePtr, ptrbuffercaps, ((void**)(*(void**)UnsafeBasePtr))[3]);
                return result;
            }
        }
                             ...
                             out IntPtr audioPtr2, out int audioBytes2, DSBLock lockFlags)
        {
            fixed (void* pAudioPtr1 = &audioPtr1, pAudioPtr2 = &audioPtr2)
            {
                ...
                {
                    DSResult result = InteropCalls.CalliMethodPtr(UnsafeBasePtr, offset, bytes,
        ...
        public void Lock(int offset, int bytes, out IntPtr audioPtr1, out int audioBytes1,
            out IntPtr audioPtr2, out int audioBytes2, DSBLock lockFlags)
        {
            DSResult result = LockNative(offset, bytes, out audioPtr1, out audioBytes1, out audioPtr2, out audioBytes2,
                lockFlags);
        ...
        {
            DSResult result = UnlockNative(audioPtr1, audioBytes1, audioPtr2, audioBytes2);
        ...
        public DSResult GetStatusNative(out DSBStatusFlags status)
        {
            ...
            {
                DSResult result = InteropCalls.CalliMethodPtr(UnsafeBasePtr, pstatus, ((void**)(*(void**)UnsafeBasePtr))[9]);
                return result;
            }
        }
        ...
        {
            int pani;
            DSResult result = GetPanNative(out pani);
        ...
        {
            int value = (int)ScalarValueToDBValue(volume, MinVolume, MaxVolume);
            SetVolume(value);
        }
