...
namespace CSCore.DirectSound
{
    ...
    public class DirectSoundDevice
    {
        ...
        public static DirectSoundDevice DefaultDevice
        {
            get
            {
                System.Collections.ObjectModel.ReadOnlyCollection<DirectSoundDevice> devices = DirectSoundDeviceEnumerator.EnumerateDevices();
                DirectSoundDevice defaultDevice = devices.FirstOrDefault(x => x.Guid == DefaultPlaybackGuid);
